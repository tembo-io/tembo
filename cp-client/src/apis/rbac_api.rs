...
pub async fn delete_policy(
    ...
    org_id: &str,
    policy_input: models::PolicyInput,
) -> Result<String, Error<DeletePolicyError>> {
...
pub async fn get_actions(
    configuration: &configuration::Configuration,
    org_id: &str,
) -> Result<Vec<models::Action>, Error<GetActionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
...
pub async fn get_policies(
    configuration: &configuration::Configuration,
    org_id: &str,
) -> Result<Vec<models::PolicyData>, Error<GetPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
...
pub async fn get_roles(
    configuration: &configuration::Configuration,
    org_id: &str,
) -> Result<Vec<models::Role>, Error<GetRolesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
...
pub async fn set_policy(
    ...
    org_id: &str,
    policy_input: models::PolicyInput,
) -> Result<String, Error<SetPolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
    let p_policy_input = policy_input;

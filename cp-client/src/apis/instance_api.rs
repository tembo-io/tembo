...
pub async fn delete_instance(
    ...
    org_id: &str,
    instance_id: &str,
) -> Result<models::Instance, Error<DeleteInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
...
pub async fn get_all(
    configuration: &configuration::Configuration,
    org_id: &str,
) -> Result<Vec<models::Instance>, Error<GetAllError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
...
pub async fn get_instance_history(
    ...
    page: Option<i32>,
    limit: Option<i32>,
) -> Result<models::HistoryPage, Error<GetInstanceHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
    let p_instance_id = instance_id;
    let p_field = field;
    ...
    let uri_str = format!(
        ...
        org_id = crate::apis::urlencode(p_org_id),
        instance_id = crate::apis::urlencode(p_instance_id),
        field = crate::apis::urlencode(p_field)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_instance_toml(
    configuration: &configuration::Configuration,
    org_id: &str,
    instance_id: &str,
) -> Result<serde_json::Value, Error<GetInstanceTomlError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
    let p_instance_id = instance_id;
...
pub async fn get_schema(
    configuration: &configuration::Configuration,
) -> Result<models::ErrorResponseSchema, Error<GetSchemaError>> {
...
pub async fn instance_event(
    configuration: &configuration::Configuration,
    org_id: &str,
    event_type: models::InstanceEvent,
    instance_id: &str,
) -> Result<models::Instance, Error<InstanceEventError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
...
pub async fn patch_instance(
    ...
    org_id: &str,
    instance_id: &str,
    patch_instance: models::PatchInstance,
) -> Result<models::Instance, Error<PatchInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;
    let p_instance_id = instance_id;
...
pub async fn restore_instance(
    configuration: &configuration::Configuration,
    org_id: &str,
    restore_instance: models::RestoreInstance,
) -> Result<models::Instance, Error<RestoreInstanceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org_id = org_id;

        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'de> Visitor<'de> for TupleVisitor {
                ...
                A: SeqAccess<'de>,
            {
                ...
                let parsed_int = str_val.parse::<i64>()
...
#[cfg(test)]
mod tests {
    use crate::metrics::prometheus::{Data, Metric, MetricsResult, PrometheusQueryResponse};
    ...
    fn deserializes_prometheus_responses_correctly() {
        let response: PrometheusQueryResponse = serde_json::from_str(QUERY_RESPONSE).unwrap();

        let expected = PrometheusQueryResponse {
            status: "success".into(),
            data: Data {

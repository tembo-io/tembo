// TODO: Delete this file after API migration
use crate::traefik::ingress_route_crd_v3::IngressRouteRoutes;
use crate::{
    apis::coredb_types::CoreDB, cloudnativepg::placement::cnpg_placement::PlacementConfig, Context,
    Error, Result,
};
use k8s_openapi::{
    api::{
...
use crate::{
    app_service::ingress_v3::{generate_ingress_tcp_routes, reconcile_ingress_tcp},
    traefik::ingress_route_tcp_crd_v3::IngressRouteTCPRoutes,
};
use tracing::{debug, error, warn};

use super::{
    ingress_v3::{generate_ingress_routes, reconcile_ingress},

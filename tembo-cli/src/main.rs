...
use crate::cmd::{apply, context, delete, init, login, logs, top, validate, update};
...
fn main() -> Result<(), anyhow::Error> {
    ...
    match app.command {
        ...
        SubCommands::Update(_update_cmd) => {
            update::execute(app.global_opts.verbose)?;
        }
    }

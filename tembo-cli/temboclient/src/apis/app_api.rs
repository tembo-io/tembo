...
pub async fn get_all_apps(configuration: &configuration::Configuration, ) -> Result<Vec<serde_json::Value>, Error<GetAllAppsError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/apps", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllAppsError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_app(configuration: &configuration::Configuration, r#type: &str) -> Result<serde_json::Value, Error<GetAppError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/apps/{type}", local_var_configuration.base_path, type=crate::apis::urlencode(r#type));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

...
impl AppType {
    pub fn new(_restapi: Option<crate::models::AppConfig>, _http: Option<crate::models::AppConfig>, _mq_api: Option<crate::models::AppConfig>, _embeddings: Option<crate::models::AppConfig>, _custom: crate::models::AppService) -> AppType {
        AppType {

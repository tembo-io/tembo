...
impl CreateInstance {
    pub fn new(cpu: crate::models::Cpu, environment: crate::models::Environment, instance_name: String, memory: crate::models::Memory, stack_type: crate::models::StackType, storage: crate::models::Storage) -> CreateInstance {
        CreateInstance {
            app_services: None,

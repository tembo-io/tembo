...
impl UpdateInstance {
    pub fn new(cpu: crate::models::Cpu, environment: crate::models::Environment, memory: crate::models::Memory, replicas: i32, storage: crate::models::Storage) -> UpdateInstance {
        UpdateInstance {
            app_services: None,

...
impl Middleware {
    ...
    pub fn new(custom_request_headers: crate::models::HeaderConfig, strip_prefix: crate::models::StripPrefixConfig, replace_path_regex: crate::models::ReplacePathRegexConfig) -> Middleware {
        Middleware {
